	...
	<body>
	    ...
	    <div class="wrapper">
	  		<main class="main">
	  			...
	  			<p class="m-p">
	  				<a>	
						当サイトの運営者は正確な商品説明と画像を提供してもらうように努めていますが、商品説明、画像、またはサイト上のその他のコンテンツが正確、完全、信頼性がある、最新である、または誤りがないことを保証するものではありません。サイト上で提供される商品が記載内容と異なる場合は、出品者・販売者に確認を求めてください。返品や交換に関する保証はありませんのでご注意ください。
	  				</a>
	  			</p>
	  			<p class="m-p">
	  				<a name="title5">
	  			...
	  			<p class="m-p">
	  				<a>	
						このサイトを通じて行われたすべての注文は、当サイトの運営者の承認を受ける必要があります。商品の在庫切れや商品説明や価格の誤り、注文の誤りなど、いかなる理由であっても注文を拒否またはキャンセルする権利を当社は有します。支払いは購入時に行われなければなりません。
	  				</a>
	  			</p>
	  			<p class="m-p">
	  				<a name="title6">
	  			...
	  			<p class="m-p">
	  				<a>	
						配送および納品の時間はおおよその目安であり、変更される可能性があります。当社は第三者の配送サービスによる遅延について責任を負いません。詳細については各店舗（販売者・出品者）に確認してください。
	  				</a>
	  			</p>
	  			<p class="m-p">
	  				<a name="title7">
	  			...
	  			<p class="m-p">
	  				<a>	
						支払い後のキャンセルはできませんが、返品や返金を希望する場合は、各販売者・出品者に連絡してください。
	  				</a>
	  			</p>
	  			<p class="m-p">
	  				<a name="title8">
