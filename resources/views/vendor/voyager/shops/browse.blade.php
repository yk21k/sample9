...
@section('content')
    ...
    @if($flow)
        @include('vendor.voyager.partials.flow_overlay_inner', [
            'flow' => $flow
        ])
    @endif
...
<script>
    document.addEventListener('DOMContentLoaded', function () {
        ...
        const STORAGE_KEY = 'flow_seen_product_registration';
...
<script>
    document.addEventListener('DOMContentLoaded', function () {
        ...
        const printBtn = document.getElementById('printFlowBtn');
        const downloadBtn = document.getElementById('downloadFlowBtn');
